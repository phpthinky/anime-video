...
<form class="form" id="frmcreate" name="frmcreate" method="post" action="<?=site_url('post/update_post');?>">
	<div class="col-md-8">
	
	<div class="panel pane-info">
	<div class="heading"><h4>Edit post <a href="<?=site_url("$p_site_path/$p_slug");?>" target="_blank" class="btn btn-sm btn-default" title="View post"><i class="fa fa-eye"></i></a></h4></div>
	<div class="body">
			<div class="form-group">
				<p class="btn hidden " id="warning_msg"></p>
			</div>
			<div class="form-group">
				<input type="hidden"  id="post_id" name="post_id" value="<?php echo isset($p_post_id) ? $p_post_id : 0;?>" />
			</div>
			<div class="form-group">
...
<div class="modal-bg hidden">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p><div class="err_msg hidden"></div>			
		<form action="<?=site_url('post/add_category');?>" method="post" name="frmcat" id="frmcat">
			<div class="form-group">
